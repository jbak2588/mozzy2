...
- [x] **Firestore Rules**:
  - [x] buyer can read own deal
  - [x] seller can read own deal
  - [x] buyer can read own private code
  - [x] seller cannot read buyer private code
  - [x] seller can submit code verification only through repository/client transaction for MVP
