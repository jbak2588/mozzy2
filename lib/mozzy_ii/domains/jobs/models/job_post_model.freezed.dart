...
switch (_that) {
case _JobPostModel() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.companyName,_that.ownerId,_that.ownerName,_that.ownerPhotoUrl,_that.shopId,_that.category,_that.jobType,_that.workType,_that.salaryType,_that.salaryMin,_that.salaryMax,_that.currency,_that.locationParts,_that.geoScope,_that.reachMode,_that.trustScore,_that.signalScore,_that.discoveryChannels,_that.mapVisibility,_that.translationState,_that.status,_that.applicantCount,_that.chatCount,_that.viewCount,_that.isDeleted,_that.isClosed,_that.boostStatus,_that.boostPaymentId,_that.boostPackageId,_that.boostStartedAt,_that.boostActiveUntil,_that.boostDurationDays,_that.boostSignalScore,_that.lastBoostedAt,_that.createdAt,_that.updatedAt,_that.expiresAt);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,description,companyName,ownerId,ownerName,ownerPhotoUrl,shopId,category,jobType,workType,salaryType,salaryMin,salaryMax,currency,locationParts,geoScope,reachMode,trustScore,signalScore,const DeepCollectionEquality().hash(_discoveryChannels),mapVisibility,const DeepCollectionEquality().hash(_translationState),status,applicantCount,chatCount,viewCount,isDeleted,isClosed,boostStatus,boostPaymentId,boostPackageId,boostStartedAt,boostActiveUntil,boostDurationDays,boostSignalScore,lastBoostedAt,createdAt,updatedAt,expiresAt]);
