...
| P2-B18 | **Admin audit log foundation** | Tracking moderation actions | firestore·dart | Audit collection records | ☑ |
...
| P2-B22 | **Marketplace staging Firebase verification** | Live connectivity / Rules / Storage / Claims | firestore·test | Partial / Blocked (Login Error) | □ |
