...
// MozzyPostContract 구현 필드
 ...
 LocationParts get location; DateTime get createdAt; DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,title,content,const DeepCollectionEquality().hash(imageUrls),category,geoScope,reachMode,const DeepCollectionEquality().hash(translationState),trustScore,signalScore,geoPath,location,createdAt,updatedAt);

@override
String toString() {
  return 'PostModel(id: $id, userId: $userId, title: $title, content: $content, imageUrls: $imageUrls, category: $category, geoScope: $geoScope, reachMode: $reachMode, translationState: $translationState, trustScore: $trustScore, signalScore: $signalScore, geoPath: $geoPath, location: $location, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String userId, String title, String content, List<String> imageUrls, String category, GeoScope geoScope, ReachMode reachMode, Map<String, String> translationState, double trustScore, double signalScore, String geoPath, LocationParts location, DateTime createdAt, DateTime? updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String title,  String content,  List<String> imageUrls,  String category,  GeoScope geoScope,  ReachMode reachMode,  Map<String, String> translationState,  double trustScore,  double signalScore,  String geoPath,  LocationParts location,  DateTime createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PostModel() when $default != null:
return $default(_that.id,_that.userId,_that.title,_that.content,_that.imageUrls,_that.category,_that.geoScope,_that.reachMode,_that.translationState,_that.trustScore,_that.signalScore,_that.geoPath,_that.location,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String title,  String content,  List<String> imageUrls,  String category,  GeoScope geoScope,  ReachMode reachMode,  Map<String, String> translationState,  double trustScore,  double signalScore,  String geoPath,  LocationParts location,  DateTime createdAt,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _PostModel():
return $default(_that.id,_that.userId,_that.title,_that.content,_that.imageUrls,_that.category,_that.geoScope,_that.reachMode,_that.translationState,_that.trustScore,_that.signalScore,_that.geoPath,_that.location,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String title,  String content,  List<String> imageUrls,  String category,  GeoScope geoScope,  ReachMode reachMode,  Map<String, String> translationState,  double trustScore,  double signalScore,  String geoPath,  LocationParts location,  DateTime createdAt,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _PostModel() when $default != null:
return $default(_that.id,_that.userId,_that.title,_that.content,_that.imageUrls,_that.category,_that.geoScope,_that.reachMode,_that.translationState,_that.trustScore,_that.signalScore,_that.geoPath,_that.location,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _PostModel extends PostModel implements MozzyPostContract {
  const _PostModel({required this.id, required this.userId, required this.title, required this.content, final  List<String> imageUrls = const [], required this.category, this.geoScope = GeoScope.neighborhood, this.reachMode = ReachMode.localOnly, final  Map<String, String> translationState = const {}, this.trustScore = 0.0, this.signalScore = 0.0, required this.geoPath, required this.location, required this.createdAt, this.updatedAt}): _imageUrls = imageUrls,_translationState = translationState,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,title,content,const DeepCollectionEquality().hash(_imageUrls),category,geoScope,reachMode,const DeepCollectionEquality().hash(_translationState),trustScore,signalScore,geoPath,location,createdAt,updatedAt);
