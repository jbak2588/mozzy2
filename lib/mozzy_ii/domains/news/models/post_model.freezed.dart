...
// MozzyPostContract 구현 필드
 ...
 bool get mapVisibility; List<String> get discoveryChannels; List<String> get relayTargets; bool get isPromoted; String get boostStatus; String? get boostPaymentId; String? get boostPackageId;@OptionalSafeDateTimeConverter() DateTime? get boostStartedAt;@OptionalSafeDateTimeConverter() DateTime? get boostActiveUntil; int get boostDurationDays; double get boostSignalScore;@OptionalSafeDateTimeConverter() DateTime? get lastBoostedAt;@SafeDateTimeConverter() DateTime get createdAt;@OptionalSafeDateTimeConverter() DateTime? get updatedAt;
...
@useResult
$Res call({
 String id, String userId, String title, String content, List<String> imageUrls, String category, GeoScope geoScope, ReachMode reachMode, Map<String, String> translationState, double trustScore, double signalScore, String geoPath, LocationParts location, String countryCode, bool isDeleted, int reportCount, int likesCount, int commentsCount, int viewsCount, bool mapVisibility, List<String> discoveryChannels, List<String> relayTargets, bool isPromoted, String boostStatus, String? boostPaymentId, String? boostPackageId,@OptionalSafeDateTimeConverter() DateTime? boostStartedAt,@OptionalSafeDateTimeConverter() DateTime? boostActiveUntil, int boostDurationDays, double boostSignalScore,@OptionalSafeDateTimeConverter() DateTime? lastBoostedAt,@SafeDateTimeConverter() DateTime createdAt,@OptionalSafeDateTimeConverter() DateTime? updatedAt
});
...
as List<String>,isPromoted: null == isPromoted ? _self.isPromoted : isPromoted // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String title,  String content,  List<String> imageUrls,  String category,  GeoScope geoScope,  ReachMode reachMode,  Map<String, String> translationState,  double trustScore,  double signalScore,  String geoPath,  LocationParts location,  String countryCode,  bool isDeleted,  int reportCount,  int likesCount,  int commentsCount,  int viewsCount,  bool mapVisibility,  List<String> discoveryChannels,  List<String> relayTargets,  bool isPromoted,  String boostStatus,  String? boostPaymentId,  String? boostPackageId, @OptionalSafeDateTimeConverter()  DateTime? boostStartedAt, @OptionalSafeDateTimeConverter()  DateTime? boostActiveUntil,  int boostDurationDays,  double boostSignalScore, @OptionalSafeDateTimeConverter()  DateTime? lastBoostedAt, @SafeDateTimeConverter()  DateTime createdAt, @OptionalSafeDateTimeConverter()  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PostModel() when $default != null:
return $default(_that.id,_that.userId,_that.title,_that.content,_that.imageUrls,_that.category,_that.geoScope,_that.reachMode,_that.translationState,_that.trustScore,_that.signalScore,_that.geoPath,_that.location,_that.countryCode,_that.isDeleted,_that.reportCount,_that.likesCount,_that.commentsCount,_that.viewsCount,_that.mapVisibility,_that.discoveryChannels,_that.relayTargets,_that.isPromoted,_that.boostStatus,_that.boostPaymentId,_that.boostPackageId,_that.boostStartedAt,_that.boostActiveUntil,_that.boostDurationDays,_that.boostSignalScore,_that.lastBoostedAt,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String title,  String content,  List<String> imageUrls,  String category,  GeoScope geoScope,  ReachMode reachMode,  Map<String, String> translationState,  double trustScore,  double signalScore,  String geoPath,  LocationParts location,  String countryCode,  bool isDeleted,  int reportCount,  int likesCount,  int commentsCount,  int viewsCount,  bool mapVisibility,  List<String> discoveryChannels,  List<String> relayTargets,  bool isPromoted,  String boostStatus,  String? boostPaymentId,  String? boostPackageId, @OptionalSafeDateTimeConverter()  DateTime? boostStartedAt, @OptionalSafeDateTimeConverter()  DateTime? boostActiveUntil,  int boostDurationDays,  double boostSignalScore, @OptionalSafeDateTimeConverter()  DateTime? lastBoostedAt, @SafeDateTimeConverter()  DateTime createdAt, @OptionalSafeDateTimeConverter()  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _PostModel():
return $default(_that.id,_that.userId,_that.title,_that.content,_that.imageUrls,_that.category,_that.geoScope,_that.reachMode,_that.translationState,_that.trustScore,_that.signalScore,_that.geoPath,_that.location,_that.countryCode,_that.isDeleted,_that.reportCount,_that.likesCount,_that.commentsCount,_that.viewsCount,_that.mapVisibility,_that.discoveryChannels,_that.relayTargets,_that.isPromoted,_that.boostStatus,_that.boostPaymentId,_that.boostPackageId,_that.boostStartedAt,_that.boostActiveUntil,_that.boostDurationDays,_that.boostSignalScore,_that.lastBoostedAt,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String title,  String content,  List<String> imageUrls,  String category,  GeoScope geoScope,  ReachMode reachMode,  Map<String, String> translationState,  double trustScore,  double signalScore,  String geoPath,  LocationParts location,  String countryCode,  bool isDeleted,  int reportCount,  int likesCount,  int commentsCount,  int viewsCount,  bool mapVisibility,  List<String> discoveryChannels,  List<String> relayTargets,  bool isPromoted,  String boostStatus,  String? boostPaymentId,  String? boostPackageId, @OptionalSafeDateTimeConverter()  DateTime? boostStartedAt, @OptionalSafeDateTimeConverter()  DateTime? boostActiveUntil,  int boostDurationDays,  double boostSignalScore, @OptionalSafeDateTimeConverter()  DateTime? lastBoostedAt, @SafeDateTimeConverter()  DateTime createdAt, @OptionalSafeDateTimeConverter()  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _PostModel() when $default != null:
return $default(_that.id,_that.userId,_that.title,_that.content,_that.imageUrls,_that.category,_that.geoScope,_that.reachMode,_that.translationState,_that.trustScore,_that.signalScore,_that.geoPath,_that.location,_that.countryCode,_that.isDeleted,_that.reportCount,_that.likesCount,_that.commentsCount,_that.viewsCount,_that.mapVisibility,_that.discoveryChannels,_that.relayTargets,_that.isPromoted,_that.boostStatus,_that.boostPaymentId,_that.boostPackageId,_that.boostStartedAt,_that.boostActiveUntil,_that.boostDurationDays,_that.boostSignalScore,_that.lastBoostedAt,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _PostModel extends PostModel {
  const _PostModel({required this.id, required this.userId, required this.title, required this.content, final  List<String> imageUrls = const [], required this.category, this.geoScope = GeoScope.neighborhood, this.reachMode = ReachMode.localOnly, final  Map<String, String> translationState = const {}, this.trustScore = 0.0, this.signalScore = 0.0, required this.geoPath, required this.location, this.countryCode = 'ID', this.isDeleted = false, this.reportCount = 0, this.likesCount = 0, this.commentsCount = 0, this.viewsCount = 0, this.mapVisibility = true, final  List<String> discoveryChannels = const <String>[], final  List<String> relayTargets = const <String>[], this.isPromoted = false, this.boostStatus = 'none', this.boostPaymentId, this.boostPackageId, @OptionalSafeDateTimeConverter() this.boostStartedAt, @OptionalSafeDateTimeConverter() this.boostActiveUntil, this.boostDurationDays = 0, this.boostSignalScore = 0.0, @OptionalSafeDateTimeConverter() this.lastBoostedAt, @SafeDateTimeConverter() required this.createdAt, @OptionalSafeDateTimeConverter() this.updatedAt}): _imageUrls = imageUrls,_translationState = translationState,_discoveryChannels = discoveryChannels,_relayTargets = relayTargets,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,title,content,const DeepCollectionEquality().hash(_imageUrls),category,geoScope,reachMode,const DeepCollectionEquality().hash(_translationState),trustScore,signalScore,geoPath,location,countryCode,isDeleted,reportCount,likesCount,commentsCount,viewsCount,mapVisibility,const DeepCollectionEquality().hash(_discoveryChannels),const DeepCollectionEquality().hash(_relayTargets),isPromoted,boostStatus,boostPaymentId,boostPackageId,boostStartedAt,boostActiveUntil,boostDurationDays,boostSignalScore,lastBoostedAt,createdAt,updatedAt]);
